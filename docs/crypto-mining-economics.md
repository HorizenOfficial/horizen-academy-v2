...
[Cryptocurrency mining](crypto-mining.md) has long been viewed as a highly rewarding activity for early adopters of blockchain technology to get involved in a particular blockchain ecosystem. 
...
The first is the _consensus mechanism_. The act of ‘mining’ is most commonly associated with proof of work blockchains like [Bitcoin](bitcoin-glossary.md), Litecoin, Bitcoin Cash or Horizen. 
...
When it comes to [proof of stake systems](pos-vs-pow.md), the economics of validating transactions and earning rewards are very different. 
...
It helps you understand how the proof of work [consensus mechanisms](consensus-mechanisms.md) are designed, and gives you the ability to get paid by performing a valuable service; to store the blockchain history and validate transactions. 
...
WIthout the secure foundation enabled by the economics of mining or validating, blockchains would not be able to operate at a scale that allows millions of people to send payments, [deploy smart contracts](smart-contracts.md), trade NFTs and perform other activities every day. 
