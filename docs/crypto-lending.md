...
One of the core [features of blockchain technology](https://www.horizen.io/academy/components-of-blockchain/) is the **[Smart Contract](https://www.horizen.io/academy/smart-contracts/)**, which is a type of computer program that executes a set of functions based on predefined rules or conditions set by the developer.
...
This means that the [protocol](https://www.horizen.io/academy/blockchain-protocols/) is _subsidizing_ the yields that lenders are earning through [token inflation](https://www.horizen.io/academy/tokenomics/). Naturally, the more tokens are printed, the less value the tokens will have. This results in a steep decline in the tokens price as lenders accrue more [tokens](https://www.horizen.io/academy/what-is-a-token/). 
...
Most tokens and cryptocurrencies other than [Bitcoin](https://www.horizen.io/academy/bitcoin-glossary/) and perhaps ETH fall into this category of collateral. 
...
The most popular decentralized applications for lending and borrowing crypto today are **Aaave** and **Compound**. These Defi protocols offer smart contract lending solutions on [Ethereum](https://www.horizen.io/academy/ethereum-glossary/). 

To use these dapps, simply:

- [Connect your wallet](https://www.horizen.io/academy/crypto-wallets/)
