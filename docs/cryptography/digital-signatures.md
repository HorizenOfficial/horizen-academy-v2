...
To summarize, [public key cryptography (PKC)](cryptography/public-key-cryptography-pkc.md) is used to verify ownership. It's basic building blocks are private keys, public keys, and a digital signatures. 
