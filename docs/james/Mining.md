...
![Mining nonce]({{site.baseurl_root}}/assets/post_files/technology/advanced/2.6-mining/hashcash_pow_D.jpg)
![Mining nonce]({{site.baseurl_root}}/assets/post_files/technology/advanced/2.6-mining/hashcash_pow_M.jpg)
...
![Hash function]({{site.baseurl_root}}/assets/post_files/technology/advanced/2.6-mining/hash_function_D.jpg)
![Hash function]({{site.baseurl_root}}/assets/post_files/technology/advanced/2.6-mining/hash_function_M.jpg)
...
![Block Reward: The sum of block subsidy and transaction fees]({{site.baseurl_root}}/assets/post_files/technology/expert/2.6-mining/block-reward.jpg)
...
![Flexibility - Efficiency Trade-Off in Mining Hardware: CPUs, GPUs, FPGAs and ASICs]({{site.baseurl_root}}/assets/post_files/technology/expert/2.6-mining/cpu-asic_D.jpg)
![Flexibility - Efficiency Trade-Off in Mining Hardware: CPUs, GPUs, FPGAs and ASICs]({{site.baseurl_root}}/assets/post_files/technology/expert/2.6-mining/cpu-asic_M.jpg)
