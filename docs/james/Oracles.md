...
description: "A Blockchain Oracle is a piece of middleware implemented within a computer node that enables blockchains to communicate with any off-chain system."
