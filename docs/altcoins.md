...
The term **altcoin** stems from a combination of '_alternative_' and '_coin_' in the sense of [cryptocurrency](cryptocurrency.md) coins. 
...
### Varying Types of Altcoins
 ...
 - Stablecoins
 - [Utility Tokens](what-is-a-token.md)
 - Memecoins
 - [Governance](blockchain-governance.md) Tokens
 - Security Tokens
 - Mining-based
 - Staking-based
...
It shows you the price of most cryptocurrencies and [tokens](what-is-a-token.md) out there, together with a bunch of other information such as links to their websites. They also let you look at historical price data and simple charts.
