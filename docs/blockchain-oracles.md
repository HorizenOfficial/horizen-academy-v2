...
- **Validate**: Using [digital signatures](digital-signatures.md) or zero-knowledge proofs to create a cryptographic proof that confirms the performance of a data oracle
