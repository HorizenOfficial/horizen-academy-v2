...
- **Directed acyclic graphs** (_DAGs_) have a different [data structure](blockchain-data-structure.md) than blockchains. Many blocks can be produced in parallel which requires modifications to the consensus mechanism.
